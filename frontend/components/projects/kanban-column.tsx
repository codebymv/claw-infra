...
export function KanbanColumn({
  ...
  const wipLimitReached: boolean = !!(column.wipLimit && sortedCards.length >= column.wipLimit);
  const wipLimitWarning: boolean = !!(column.wipLimit && sortedCards.length >= column.wipLimit * 0.8);
